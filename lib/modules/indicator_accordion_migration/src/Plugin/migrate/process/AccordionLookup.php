...
namespace Drupal\indicator_accordion_migration\Plugin\migrate\process;
...
/**
 * Accordion Lookup process plugin.
 *
 * @MigrateProcessPlugin(
 *   id = "accordion_lookup"
 * )
 */
final class AccordionLookup extends ProcessPluginBase implements ContainerFactoryPluginInterface {
  /**
