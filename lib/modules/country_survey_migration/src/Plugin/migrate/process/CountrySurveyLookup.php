...
namespace Drupal\country_survey_migration\Plugin\migrate\process;
...
/**
 * Country Survey Lookup process plugin.
 *
 * @MigrateProcessPlugin(
 *   id = "country_survey_lookup"
 * )
 */
final class CountrySurveyLookup extends ProcessPluginBase implements ContainerFactoryPluginInterface {
  /**
