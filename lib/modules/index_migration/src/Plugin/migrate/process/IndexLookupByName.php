...
/**
 * Index Lookup By Name process plugin.
 *
 * @MigrateProcessPlugin(
 *   id = "index_lookup_by_name"
 * )
 */
final class IndexLookupByName extends ProcessPluginBase implements ContainerFactoryPluginInterface {
  /**
